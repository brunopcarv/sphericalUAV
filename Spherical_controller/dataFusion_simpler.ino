...
////###########################################################################################
////####### PID Initialization Part of the Code ###############################################
//==================================PID Variables=========================================
...
// SERVOS (FLAPS)
int flap1_cmd = 45, flap2_cmd = 45, flap3_cmd = 45, flap4_cmd = 45;
...
//#####################################################################################################################################
  ...
  attitude_Control(roll_ref, pitch_ref, dot_yaw_ref, roll, pitch, yaw, &flap1_cmd, &flap2_cmd, &flap3_cmd, &flap4_cmd);

  //SERVO OUTPUT (PUT IT IN ANOTHER THREAD)
  myservo.write(flap1_cmd);
  //Serial.print("Flap1 cmd: ");
  //Serial.println(flap1_cmd);
